...
class FeatureTracker
{
  public:
    ...
    void setPrediction(map<int, Eigen::Vector3d> &predictPts);//// llg modify
    double distance(cv::Point2f &pt1, cv::Point2f &pt2);///// llg modify
    ...
    vector<cv::Point2f> predict_pts, predict_pts_debug;/// llg modify
    bool hasPrediction;// llg modify
    static int n_id;
};
